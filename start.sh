...
# This script relies on both binaries (dps-auth-api-migrate and dps-auth-api) being in the root path.
...
cleanup() {
    local signal=$1
    echo "[Start] Received $signal signal, forwarding to dps-auth-api..."
